...
public class QueryGrantTypeService {
    ...
    private static final Map<String, GrantTypeService> strategies = new HashMap<>();
    ...
    public void dispatcherInit(){
        ...
        strategies.put("红包",new GrantTypeService());
    }
    ...
    public GrantTypeService getGrantTypeSecond(String type) {
       if (type==null||type==""){
           throw new NullPointerException("参数不能为空！");
       }
        return strategies.get("红包");
    }
}
